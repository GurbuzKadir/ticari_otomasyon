        ...
        3: function(t, e, n) {
            ...
            i.a.summernote = i.a.summernote || {
                ...
                "en-US": {
                    font: {
                        ...
                        size: "Yazı boyutu",
                        sizeunit: "Yazı Boyutu Birimi"
                    },
                    image: {
                        image: "Resim",
                        insert: "Resim ekle",
                        resizeFull: "100% yeniden boyutlandır",
                        resizeHalf: "50% yeniden boyutlandır",
                        resizeQuarter: "25% yeniden boyutlandır",
                        resizeNone: "Orijinal boyut",
                        floatLeft: "Sola Yasla",
                        floatRight: "Sağa Yasla",
                        floatNone: "Yaslama kaldır",
                        shapeRounded: "Şekil: Yuvarlak",
                        shapeCircle: "Şekil: Daire",
                        shapeThumbnail: "Şekil: Küçük resim",
                        shapeNone: "Şekil: Yok",
                        dragImageHere: "Resmi veya metni buraya sürükleyin",
                        dropImage: "Bırak : resim veya Metin",
                        selectFromFiles: "Dosyalardan seçin",
                    ...
                    video: {
                        ...
                        insert: "Video Ekle",
                        url: "Video URL",
                        providers: "(YouTube, Vimeo, Vine, Instagram, DailyMotion yada Youku)"
                    },
                    link: {
                        link: "Link",
                        insert: "Link ekle",
                        ...
                        url: "Bu bağlantı hangi URL'ye gitmeli?",
                    ...
                    color: {
                        ...
                        setTransparent: "Şeffaflık ayarı",
                        reset: "Sıfırla",
                    ...
                    shortcut: {
                        ...
                        extraKeys: "Ekstra anahtarlar"
                    },
                    help: {
                        escape: "Kaçış(esc)",
                        insertParagraph: "Paragraf Ekle",
                        undo: "Son komutu geri al",
                        redo: "Son komutu yeniden yap",
                        tab: "Sekme",
                        untab: "Sekmeyi kaldır",
                        bold: "Kalın bir stil ayarlayın",
                        italic: "İtalik bir stil ayarlayın",
                        underline: "Altı çizili bir stil ayarlayın",
                        strikethrough: "Üstü çizili bir stil ayarlayın",
                        removeFormat: "Bir stili temizleyin",
                        justifyLeft: "Sola hizalayın",
                        justifyCenter: "Merkeze hizalayın",
                        justifyRight: "Sağa hizalayın",
                        justifyFull: "İki yana hizalayın",
                        insertUnorderedList: "Sırasız listeyi değiştir",
                        insertOrderedList: "Sıralı listeyi değiştir",
                        outdent: "Geçerli paragrafta girintiyi azalt",
                        indent: "Geçerli paragrafta girinti",
                        formatPara: "Mevcut bloğun formatını paragraf olarak değiştir (P etiketi)",
                        formatH1: "Mevcut bloğun formatını şu şekilde değiştir: H1",
                        formatH2: "Mevcut bloğun formatını şu şekilde değiştir: H2",
                        formatH3: "Mevcut bloğun formatını şu şekilde değiştir: H3",
                        formatH4: "Mevcut bloğun formatını şu şekilde değiştir: H4",
                        formatH5: "Mevcut bloğun formatını şu şekilde değiştir: H5",
                        formatH6: "Mevcut bloğun formatını şu şekilde değiştir: H6",
                        insertHorizontalRule: "Yatay cetvel ekle",
                        "linkDialog.show": "Bağlantı İletişim Kutusunu Göster"
                    },
                    history: {
                        undo: "Geri al",
                        redo: "İleri al"
            ...
            var Rt = function() {
                function t(e) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this.bullet = new It, this.options = e.options
                }
                var e, n, o;
                return e = t, (n = [{
                    key: "insertTab",
        ...
        51: function(t, e, n) {
            ...
            var s = function() {
                function t(e, n) {
                    if (function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), this.$node = e, this.options = i.a.extend({}, {
                            title: "",
                            target: n.container,
                            trigger: "hover focus",
                            placement: "bottom"
                        }, n), this.$tooltip = i()(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"></div>', '<div class="note-tooltip-content"></div>', "</div>"].join("")), "manual" !== this.options.trigger) {
                        var o = this.show.bind(this),
                            r = this.hide.bind(this),
                            a = this.toggle.bind(this);
                        this.options.trigger.split(" ").forEach((function(t) {
                            "hover" === t ? (e.off("mouseenter mouseleave"), e.on("mouseenter", o).on("mouseleave", r)) : "click" === t ? e.on("click", a) : "focus" === t && e.on("focus", o).on("blur", r)
                        }))
                    }
                }
                var e, n, o;
            ...
            var c = function() {
                function t(e, n) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this.$button = e, this.options = i.a.extend({}, {
                        target: n.container
                    }, n), this.setEvent()
                }
                var e, n, o;
            ...
            i()(document).on("click", (function(t) {
                i()(t.target).closest(".note-btn-group").length || (i()(".note-btn-group.open").removeClass("open"), i()(".note-btn-group .note-btn.active").removeClass("active"))
            })), i()(document).on("click.note-dropdown-menu", (function(t) {
                i()(t.target).closest(".note-dropdown-menu").parent().removeClass("open"), i()(t.target).closest(".note-dropdown-menu").parent().find(".note-btn.active").removeClass("active")
            }));
            var u = c;
            ...
            var h = function() {
                    function t(e) {
                        ! function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), this.$modal = e, this.$backdrop = i()('<div class="note-modal-backdrop"/>')
                    }
                    var e, n, o;
                    return e = t, (n = [{
                        key: "show",
                            ...
                            e.find(".note-dimension-picker-mousecatcher").css({
                                ...
                                ! function(t, e, n) {
                                    ...
                                    l.css({
                                        width: d + "em",
                                        height: h + "em"
                                    }), s.data("value", d + "x" + h), d > 3 && d < e && c.css({
                                        width: d + 1 + "em"
                                    }), h > 3 && h < n && c.css({
                                        height: h + 1 + "em"
                                    }), a.html(d + " x " + h)
